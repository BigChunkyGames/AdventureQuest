...
DAMAGING_CONSUMABLES = ["Deadly Poison!", getRandomColor().title()+" Poison", "Bottle of Fire", "Grenade", "Shuriken", "Wad of Nails", "Brick", "Sharp Rock", "Throwing Knife", "Bomb", "Semtex Grenade"] # color red, you threw the ...
