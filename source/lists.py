...
# TODO fucking fix consumables again (and give them prefixes)
# you found ...
HEALING_CONSUMABLES = ['Jar of Honey', "Bag of Doritos", "Squishy Goo", getRandomColor().title() + " Potion", "Beef Jerky", "5 Dollar Fill-Up®", "Candied Nuts", "Trail Mix", "Box of Raisins", "Bag of M&M's", "Freshly Cut Grass Clippings", "Can of Soup", "Carrot", "Celery", "Tomato", "Broccoli", "Potato","Quinoa", "Kale","Spinach", "Apples", "Pear"  ] # TODO more
DAMAGING_CONSUMABLES = ["Deadly Poison!", getRandomColor().title()+" Poison", "Bottle of Fire", "Grenade", "Shuriken", "Wad of Nails", "Brick", "Sharp Rock", "Throwing Knife", "Bomb", "Semtex Grenade", "Broken Bottle",'Darts', "Bag of Dust", "Stink Bomb", 'Boomerang',] # color red, you threw the ...
EXPERIENCE_CONSUMABLES = ["Weird Mushroom", "Tiny Square of Paper", "'Grass'","'Broccoli'","Bag of Brown Hash"  ]
