...
def getRandomCouch():
    return getRandomIndex(COLORS) +" "+getRandomIndex(FABRICS) +" "+getRandomIndex(COUCHES)

def getRandomFeeling(): # edjectives
    return getRandomIndex(FEELINGS)
...
INVALID_OPTION = ["That is not a good choice." ,"Pick something else.", "I'm really going to need you to input a valid option.",
 "Try that again.", "Try that again but this time choose a valid option.", "THROW EXCEPTION: \"User chose an option that wasn't one of the words surrounded by single quotes like they should have\"", "raise AssertionError(\"User doesn't understand how to type on a keyboard.\")", 
...
COUCHES = ['couch', 'sofa', 'love seat', 'futon','bean bag chair', 'armchair', ]
FABRICS = ['leather', 'vinyl', 'corduroy', 'canvas', 'plush', 'microfiber', 'crusty']
# it feels...
FEELINGS = ['OK', 'nice', 'alright', 'splendid', 'perfect', 'like a cloud', 'shitty', 'terrible', 'depressing', 'unmotivating', 'comforting', 'warm', 'cold', 'empty', 'wholesome', 'hard', 'soft', 'average', 'normal', 'like no feeling you have ever had before.', 'nostalgic', 'familiar', 'crazy', 'awesome', 'wicked', 'sick', 'cool', 'legit', 'sub-par', 'disgusting',]
### NPC's #############################################################################

#(hints)
MOTHERLYPLATITUDES = ["There's no 'I' in 'Team'!", "Everybody makes mistakes. Don't forget that the game saves every time you travel!", "Time heals all wounds. If you're injured, find a place to sleep!", "Work smarter, not harder. A lot of times, you can just type the first letter of a choice instead of the whole word.", "Not everything is obvious! Sometimes you can choose options that aren't listed, like 'back' to cancel what you're doing.", "First time's the charm! Don't forget that you can hit the up arrow to select previously typed text.", "People say that there are holes all around that can help you get to where you're going. Might be useful!", "Capitalization won't get you anywhere. Your input is always converted to lowercase anyway!", "Don't get stuck! Just type 'load' to load your most recent game!"]# TODO more
...
CURSES = ['fuck', 'shit', 'bitch', 'hoe', 'ho', 'cunt', 'wretch', 'whore', 'ass', 'dick', 'prick', 'cock', 'peener', 'vag', 'pussy', 'asshole', 'bastard', 'damn', 'bollocks', 'christ', 'hell', 'motherfucker', 'mother fucker', 'shitass', 'twat', 'jesus', 'song of a bitch','fucker', ]

### items ##############################################################################
WEAPON = ['Great Sword', 'Claymore', 'Dagger', 'Staff', 'Hatchet', 'Nunchucks', 'Switchblade', 'Butterfly Knife', 'Mace', 'Club', 'Trident', 'Spear', 'Sickle', 'Bow and Arrow', 'Sheers', 'Sling',  'Whip', 'Spade', 'Hammer', "Boxing Gloves", "Gardening Gloves", "Shovel", "Pick Axe", "Blender", "Paper Airplane", "Banjo", "Drum Stick", "Battle Toaster", "Chef Knife", 'Cheese Knife', 'Piece of Bark', 'Crab', 'Scissors', 'Envelope Opener', 'Cat Food Can Lid', 'Staple Gun', 'Nail Gun',  'Halberd', 'Finger Nail Clipper', 'Bubble Gun', 'Lawn Flamingo', 'Syringe', 'Sickle', 'Khopesh', 'Spork',  'Knitting Needle', 'Trident', 'Nerf Gun', 'Water Gun' ]
...
# you found ...
HEALING_CONSUMABLES = ['Jar of Honey', "Bag of Doritos", "Squishy Goo", getRandomColor().title() + " Potion", "Beef Jerky", "5 Dollar Fill-Up®", "Candied Nuts", "Trail Mix", "Box of Raisins", "Bag of M&M's", "Freshly Cut Grass Clippings", "Can of Soup", "Carrot", "Celery", "Tomato", "Broccoli", "Potato","Quinoa", "Kale","Spinach", "Apples", "Pear", 'Brussel Sprouts', 'Baked Chicken Breast', "Roast Salmon", 'Tuna Salad', 'Corn on the Cobb', 'Half of a Chipotle Burito', 'Chicken Tostasdas', 'Gumbo Shrimp'  ] # TODO more
DAMAGING_CONSUMABLES = ["Deadly Poison!", getRandomColor().title()+" Poison", "Bottle of Fire", "Grenade", "Shuriken", "Wad of Nails", "Brick", "Sharp Rock", "Throwing Knife", "Bomb", "Semtex Grenade", "Broken Bottle",'Darts', "Bag of Dust", "Stink Bomb", 'Boomerang','Ninja Stars','Bag of C4',] # color red, you threw the ...
EXPERIENCE_CONSUMABLES = ["Weird Mushroom", "Tiny Square of Paper", "'Grass'","'Broccoli'","Bag of Orbies ",'Beer', 'Bottle of Vodka' , 'Jar of Moonshine'  ]

ITEM_PREFIX_SHITTY = ["Ugly", 'Shitty', 'Dirty', "Really Dull", "Damaged", "Fake", "Cardboard" ,"Holographic", "Awkward", "Uncomfortable", "Disgusting", "Wobbly", "Hairy", "Wet","Harmless", ]
ITEM_PREFIX_BAD = ["Bad", "Rusty", "Hardy", "Unwieldy", "Dull", "Poor", "Stupid", "Corroded","Sticky", "Wooden",  "Plastic", "Uniquely Shaped", "Vintage", "Jiggly", "Average", "Precarious"]
...
ITEM_PREFIX_GOOD = ["Good", "Bad Ass", "Pretty Good", "Swift", "Near-mint", "Sharp",'Like-new', "Elven", "Holy", "Blessed", getRandomDankAdjective(), "Glass", "Comfortable", "Stylish", "Grass", "Electromagnetic", "Sacred", "Chrome", "Spring Loaded", "Sexy", "Sneaky", "Flamboyant", "Romantic", "Swanky","Dangerous", "Threatening", "Treacherous", "Menacing"]
ITEM_PREFIX_REALLYGOOD = ["Really Good", "Excellent", "Prestine", "Very Sharp", "Executive", "Diamond","Beautiful", "Dangerous", ]
